...
import { useEMRHClosed } from "./useEMRHClosed";
...
const EMRHClosed = (props: EMRHClosedProps) => {
  const { handlePushProfile } = useEMRHClosed(props);
...
export default React.memo(EMRHClosed);
